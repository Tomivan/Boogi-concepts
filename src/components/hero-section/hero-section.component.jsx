        ...
        <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <Carousel fade>
                    ...
                    <Carousel.Item>
                        <img src={Background2} alt='a woman with the eiffel tower background' loading='lazy' fetchPriority='low' height="500" width="100%" className='width'/>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img src={Background3} alt='a perfume bottle with a nightclub background' loading='lazy' fetchPriority='low' height="500" width="100%" className='width'/>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img src={Background5} alt='a black perfume in a black background' loading='lazy' fetchPriority='low' height="500" width="100%" className="width" />
                    </Carousel.Item>
                </Carousel>
            </div>
